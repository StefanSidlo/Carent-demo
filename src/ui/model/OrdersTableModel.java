 ...
 */
public class OrdersTableModel extends AbstractTableModel implements TableModel{
    private final List<Order> orders;

    public OrdersTableModel(String username, OrderDao orderDao, OrderProgress progress){
        this.orders = orderDao.findAllByProgressAndUser(username, progress);
    }

    public OrdersTableModel(OrderDao orderDao){
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        return COLUMNS.get(columnIndex).getValue(orders.get(rowIndex));
    }
}
